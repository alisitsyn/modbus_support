...
typedef struct mb_descr_entry_s mb_descr_entry_t;

/**
 * @brief Find modbus register descriptor
 * 
 * @param type Modbus registers area descriptor structure
 * @param addr Modbus registers area descriptor structure
 * @param regs
 * 
 *  @return register entry type
 */
mb_descr_entry_t* mbc_slave_find_reg_descriptor(mb_param_type_t type, uint16_t addr, size_t regs);
